...
public class GameHelper {
  ...
  public ArrayList<String> placeStartup(int startupSize) {
    ...
    while (!success & attempts++ < MAX_ATTEMPTS) {      // main search loop
      ...
      System.out.print("startupCount: " + startupCount);
      System.out.print(" , Trying: " + Arrays.toString(startupCoords));
      System.out.println();
      ...
      if (startupFits(startupCoords, increment)) {      // startup fits on the grid?
        ...
        System.out.println("startupFits exist. try again");
        ArrayList<String> alphaCells_t = convertCoordsToAlphaFormat(startupCoords);
        System.out.println("Fits fail, Placed at: "+ alphaCells_t);
      }
    }                                                   // end while
